        ...
        <div class="container-lg">
            <div class="row g-2 justify-content-center">
                <div class="col-4 my-5">
                    <div class="p-32border bg-light" style="font-size: 1.5rem">Created By:{{ $task->user->name }}</div>
                </div>
                <div class="col-4 my-5 ">
                    <div class="p-32border bg-light" style="font-size: 1.5rem">Created
                        On:{{ date_format($task->created_at, 'M/d/Y H:i') }}</div>
                </div>
                <div class="col-4 my-5 ">
                    <div class="p-32border bg-light" style="font-size: 1.5rem">Status
                ...
                <div class="container px-5 bg-dark">
                            ...
                            @else
                                <div class="chat-message d-flex mt-3 mb-3">
                                    <img class="rounded-circle shadow-1-strong me-3"
                                        ...
                                        width="40  " height="40" />
                                    <div class="message-text bg-light px-3 py-2 rounded-start">{{ $comment->comment_text }}
                                    </div>
                    ...
                    <form action="/comment/post" method="post">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="text" name="comment_text" class="form-control me-3"
